...
$('#btn').click(function(){
	$.getJSON("SearchByTrackingIDJSON",{ajax:true,tid:$('#tid').val()},function(data){
	    ...
	    h+='<tr><td><i>Loaction:</i></td><td><input type=text id=lat placeholder=Latitude>&nbsp;&nbsp;<input tyoe=text id=lng placeholder=Longitude></td></tr>';
	    h+='<tr><td><input type=button value=submit id=sbtn><br><br><span id=msg>...</td><td>&nbsp;</td></tr>';
	    h+='</table></td></tr></table>';
