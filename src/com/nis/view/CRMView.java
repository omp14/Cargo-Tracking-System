...
public class CRMView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<tr><td><b><i>Tracking Id:</i></b></td><td><input class='form-control' type=text name=tid id=tid></td><td><input class='btn btn-info' type=button value='search' id=btn></td></tr>");
