...
INSERT INTO `consigner` (`id`,`firmname`,`registration_no`,`ownername`,`contactperson`,`mobileno`,`phoneno`,`email`,`address`,`country`,`state`,`city`,`deals_in`,`website`,`firmlogo`,`password`) VALUES 
 ...
 (9,'Kotak ','122','Mr Mittal','Mr Sappal','null','989','guptashubham.691@gmail.com','Hazeera','91','4','9','Bomns','www.bombsindia.com','FB_20160317_20_49_04_Saved_Picture(2).jpg','123'),
 (10,'Shubham','12122','22','22','null','22','22','22','91','3','2','ss','ss','Screenshot (3).png','11');
...
INSERT INTO `crm` (`Trackingid`,`EmployeeID`,`Curdate`,`Currtime`,`Conversation`,`Action`,`TransactionID`) VALUES 
 ...
 (28,3,'100','100','100','100',8),
 (28,3,'09/09/2017','09:09:09','ghhj','fgjh',9);
...
INSERT INTO `dispatch` (`employeeid`,`transactionid`,`dispatchdate`,`dispatchtime`,`consignerid`,`consigneeid`,`productdesc`,`producttype`,`totalbox`,`quaintity_in_box`,`amount`,`chargedispatch`,`dispatchfrom`,`dispatchto`,`dispacthBy`,`veichelNo`,`approxday`,`latitude`,`longitude`) VALUES 
 ...
 (3,25,'2017/8/14','1:49:32',8,3,'ss','Solid','22','22','22','22','22','22','Sea Route','22','22','22','22'),
 (3,26,'2017/8/15','5:26:11',8,2,'It is  a heavy product','Solid','12','12','12','22','22','22','Sea Route','22','22','22','22'),
 (3,27,'2017/8/15','5:32:49',8,2,'AS','Solid','aa','1','1','1','1','1','Air','1','1','11','11'),
 (3,28,'2017/8/15','5:34:33',8,3,'It is a heavy product','Liquid','100','1001','1001','100','110','110','Air','111','111','111','111');
...
INSERT INTO `tracking` (`trackingtranscationid`,`trackingid`,`employeeid`,`tdate`,`ttime`,`description`,`lat`,`lng`) VALUES 
 (1,15,3,'2017-07-28','2017/7/28','Dispatch From:sd\rDispatch To:sd\rDispatch By:Sea Route\rVehicle No: sd','0','0'),
 (2,16,3,'2017-07-28','1:41:8','Dispatch From:SA\rDispatch To:SA\rDispatch By:Sea Route\rVehicle No: as','0','0'),
 (3,17,3,'2017-07-28','1:44:47','Dispatch From:as\rDispatch To:as\rDispatch By:Sea Route\rVehicle No: as','0','0'),
 (4,18,3,'2017-07-28','1:48:7','Dispatch From:D\rDispatch To:D\rDispatch By:Road\rVehicle No: D','0','0'),
 (5,19,3,'2017-07-28','1:52:21','Dispatch From:ds\rDispatch To:ds\rDispatch By:Sea Route\rVehicle No: sd','0','0'),
 (6,20,3,'2017-07-28','1:59:45','Dispatch From:sd\rDispatch To:sd\rDispatch By:Air\rVehicle No: DS','0','0'),
 (7,21,3,'2017-07-28','2:21:35','Dispatch From:dd\rDispatch To:Dd\rDispatch By:Air\rVehicle No: Dd','0','0'),
 (8,22,3,'2017-07-28','2:47:55','Dispatch From:as\rDispatch To:as\rDispatch By:Road\rVehicle No: as','s','s'),
 (9,23,3,'2017-07-28','2:48:23','Dispatch From:sd\rDispatch To:D\rDispatch By:Air\rVehicle No: sd','ddd','d'),
 (10,23,3,'ss','ss','ss','ss','ss'),
 (11,23,3,'ss','ss','ss','ss','ss'),
 (12,25,3,'2017/8/14','1:49:32','Dispatch From:22\rDispatch To:22\rDispatch By:Sea Route\rVehicle No: 22','22','22'),
 (13,26,3,'2017/8/15','5:26:11','Dispatch From:22\rDispatch To:22\rDispatch By:Sea Route\rVehicle No: 22','22','22'),
 (14,28,3,'2017/8/15','5:34:33','Dispatch From:110\rDispatch To:110\rDispatch By:Air\rVehicle No: 111','111','111'),
 (15,28,3,'2017/11/28','5.35','it is alight product','11','11'),
 (16,28,3,'dd','dd','dd','dd','dd');
