...
public class EmployeeDisplayById extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<tr>");
        out.println("<td><b><i>Employee Name:</i></b></td><td><input type=text class='form-control' name=employeename value='"+E.getEmployeename()+"' size=30></td>");
        out.println("</tr>");
        
        out.println("<tr>");
        out.println("<td><b><i>DOB:</i></b></td><td><input type=text class='form-control'   value='"+E.getDob()+"' name=dob size=30></td>");
        out.println("</tr>");
        
        
        out.println("<tr>");
        out.println("<td><b><i>Address:</i></b></td><td><input type=text class='form-control' name=address  value='"+E.getAddress()+"' size=30></td>");
        out.println("</tr>");
        ...
        out.println("<tr>");
        out.println("<td><b><i>Phone No:</i></b></td><td><input class='form-control' type=text name=phoneno  value='"+E.getPhone()+"' size=30></td>");
        out.println("</tr>");
    
        out.println("<tr>");
        out.println("<td><b><i>Mobile No:</i></b></td><td><input class='form-control' type=text name=mobileno  value='"+E.getMobile()+"' size=30></td>");
        out.println("</tr>");
     
        out.println("<tr>");
        out.println("<td><b><i>Qualifications:</i></b></td><td><input class='form-control' type=text name=qualification  value='"+E.getQualification()+"' size=30></td>");
        out.println("</tr>");
        
        
        out.println("<tr>");
        out.println("<td><b><i>Designation:</i></b></td><td><input class='form-control' type=text name=designation  value='"+E.getDesignation()+"' size=30></td>");
        out.println("</tr>");
        ...
        out.println("<tr>");
        out.println("<td><input type=submit name=btn class='btn btn-info' value=Edit></td><td><input class='btn btn-success' type=Submit name=btn value=Delete></td>");
        out.println("</tr>");
        out.println("</table>");
        out.println("</td><td valign=top>");
        out.println("<img src=images/"+E.getPhotograph()+" width=250 height=250><br><br><b><i>Update Picture:<i><br><input type=file name=photograph><br><br><input class='btn btn-info' type=submit name=btn value=Update></td></tr></table>");
