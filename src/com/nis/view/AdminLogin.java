...
public class AdminLogin extends HttpServlet {
	...
	//	out.println("        <a href='login-page.html' class='btn tp-btn tp-btn-blue'>Login</a>  ");
		...
		out.println("                        	<h2 class='tp-title'>Account Log In</h2>      ");
		out.println("<form action=CheckAdminLogin method=post>");
		out.println("                                <div class='form-group'>");
		out.println("                                  <label class='control-label' for='email'>Admin ID</label>  ");
		out.println("                                  <input  name='aid' type='text' placeholder='' class='form-control input-md' required>");
		out.println("                                </div>");
		out.println("                                <div class='form-group'>");
