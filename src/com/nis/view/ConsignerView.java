...
public class ConsignerView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<tr>");
        out.println("<td><b><i>Firm Name:</i></b></td><td><input class='form-control' type=text name=firmname required size=30></td>");
        out.println("</tr>");
        
        out.println("<tr>");
        out.println("<td><b><i>Registration No:</i></b></td><td><input class='form-control' type=text  required name=registrationno size=30></td>");
        out.println("</tr>");
        ...
        out.println("<tr>");
        out.println("<td><b><i>Email Id:</i></b></td><td><input class='form-control' type=text name=email  required size=30></td>");
        out.println("</tr>");
        ...
        out.println("<tr>");
        out.println("<td><b><i>State:</i></b></td><td><select class='form-control' id=state name=state><option>-Select-</option></select></td>");
        out.println("</tr>");
        
        out.println("<tr>");
        out.println("<td><b><i>City:</i></b></td><td><select class='form-control' id=city name=city><option>-Select-</option></select></td>");
        out.println("</tr>");
        ...
        out.println("<tr>");
        out.println("<td><b><i>Website:</i></b></td><td><input class='form-control' type=text name=website required size=30></td>");
        out.println("</tr>");
        
		
        out.println("<tr>");
        out.println("<td><b><i>Firm Logo:</i></b></td><td><input class='form-control' type=file required name=firmlogo></td>");
        out.println("</tr>");
